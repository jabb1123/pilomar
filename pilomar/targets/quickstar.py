...
from pilomar.celestial.trig import AltAzToXYZ, XYZToAltAz, RotateXYZonXaxis, RotateXYZonZaxis
...
class QuickStar(AttributeMaster):
    ...
    def _calculate_base_xyz(self, alt: float, az: float) -> tuple:
        ...
        x, y, z = RotateXYZonXaxis(x, y, z, 90 - self.home_latitude)
        return x, y, z
    ...
    def alt_az(self, timestamp) -> tuple:
        ...
        x, y, z = RotateXYZonZaxis(self.base_x, self.base_y, self.base_z, time_angle)
        
        # Add observer's latitude back
        x, y, z = RotateXYZonXaxis(x, y, z, self.home_latitude - 90)
    ...
    def AltAz(self, timestamp):
        """Legacy method name."""
        return self.alt_az(timestamp)
    
    def CalculateBaseXYZ(self, alt: float, az: float):
        """Legacy method name."""
        return self._calculate_base_xyz(alt, az)
